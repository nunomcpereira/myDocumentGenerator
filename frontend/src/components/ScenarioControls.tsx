      ...
      {hideHeader ? null : (
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-steel">
            {description ?? "A scenario stores the template, enhancement document, examples, the ordered interview prompt list, the draft document, and export language configuration under the root scenarios folder."}
          </p>
        </div>
      )}
